...
labeled_peaks
ggsave(plot = x , file = 'peaks_labeled_uniquely_mapped_transcript_lengths.pdf', height = 5, width = 10)
...
labeled_peaks
ggsave(plot = x , file = 'peaks_labeled_supplementary_transcript_lengths.pdf', height = 5, width = 10)
